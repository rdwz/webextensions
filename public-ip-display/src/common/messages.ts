...
type SeparatorMessage = {subject: typeof topics.reportingSeparator; separator: string};
...
export type Message = ReturnType<typeof signal> | CopiedMessage | SeparatorMessage;
